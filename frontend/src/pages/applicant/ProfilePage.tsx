...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="max-w-xl mx-auto px-3 sm:px-4 py-4 sm:py-8 space-y-6 font-sans">
      
      {/* Main Vertical Profile Card */}
      <div className="bg-white rounded-3xl border border-[#c9b79c] shadow-lg shadow-slate-200/40 p-6 sm:p-8 flex flex-col items-center text-center relative overflow-hidden">
        ...
        <div className="self-end z-10 mb-2">
          {!isEditing ? (
            <button
              ...
              className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-xs transition-colors cursor-pointer border border-slate-200"
            >
            ...
            <button
              ...
              className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-700 font-medium text-xs transition-colors cursor-pointer border border-rose-200"
            >
        ...
        {/* Compact 1-Line Horizontal Government Credentials Bar (Only for Student Applicants) */}
        {user?.role === 'applicant' && (
          <div className="w-full mb-4 bg-[#fdfbf7] border border-[#dfcdb1] rounded-2xl p-2 sm:p-2.5 flex flex-col sm:flex-row items-center justify-between gap-2 z-10 shadow-xs">
            {/* 1. Aadhaar Card Verified */}
        ...
        <form onSubmit={handleSave} className="w-full space-y-4 text-left border-t border-[#dfcdb1] pt-6 z-10">
          ...
          <div className="flex flex-col space-y-1.5">
            <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
              ...
              {isEditing && <span className="text-[10px] text-amber-600 font-medium">Editable</span>}
            </label>
            {isEditing ? (
              <input
                type="text"
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:ring-2 focus:ring-slate-900 focus:bg-white transition-all text-slate-900 outline-hidden"
              />
            ) : (
              <div className="px-4 py-2.5 bg-[#fdfbf7] border border-[#dfcdb1] rounded-xl text-sm font-semibold text-slate-900">
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            {isEditing ? (
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-xs text-slate-500 font-bold pointer-events-none">
                  +91
                </span>
                <input
                  type="tel"
                  ...
                  maxLength={10}
                  className="w-full pl-12 pr-4 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:ring-2 focus:ring-slate-900 focus:bg-white transition-all text-slate-900 outline-hidden"
                />
              </div>
            ) : (
              <div className="px-4 py-2.5 bg-[#fdfbf7] border border-[#dfcdb1] rounded-xl text-sm font-semibold text-slate-900">
          ...
          {isEditing && (
            <div className="pt-3 flex items-center gap-3">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-3 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm shadow-md transition-all flex items-center justify-center space-x-2 cursor-pointer disabled:opacity-70"
              >
                {loading ? (
                  <>
              ...
              <button
                type="button"
                onClick={handleCancel}
                className="py-3 px-4 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm transition-colors cursor-pointer border border-slate-300"
              >
                Cancel
              </button>
            </div>
